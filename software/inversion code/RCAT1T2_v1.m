...
NumLongDelays = ceil(NumT1Times/7);
...
startecho = 3; endecho = min(25,NumEchoes);
...
theIndex = find(theAlphalist==1); %choose alpha index to plot
...
if 0
    ...
    FLIPlot2dFullT1T2(T2,T1,(FEstlist{3}.f).'); %This seems to be the correct presentation, Ray 8/15/2017
end
