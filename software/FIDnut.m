function [y2,f,p0]=FIDnut(infreq, RD, tune,TD,t90,NA,dummyscan,p,myNMR)
...
%    myNMR.setNMRparameters(p.i_freq, LarmorFreq+o1);pause(0.1);
    myNMR.setNMRparameters(p.i_T90, t90(i)); pause(0.1);
 ...
 %   subplot(2,1,1)
    ...
    ylabel('NMR signal')
    title([num2str(i) ' out of ' num2str(length(t90))])
