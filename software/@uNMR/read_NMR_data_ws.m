function [res] = read_NMR_data_ws(obj,npts)
% serial connection to uNMR pcb
% YS nov 30, 2016 -- 
% YT 1/30/2018  This code read 32 bit NMR data
...
chunksize = 60; % max chunk to transfer via serial link 1/25/2018
...
function res = read1chunk(obj,howmany)
    ...
    for ii=kk
        k=ii;
        y0 = obj.read_register(105,k*2,k*2*2+5);    % return two chars per register
        y=[y y0];
        pause(0.005);
    end
