...
PAGE 0 :
   ...
   RAML1      : origin = 0x009000, length = 0x003000	 /* Speck - changed from 0x001000 to 0x003000 to prevent running out of memory if optimization is off*/
...
PAGE 1 :
   ...
   RAML4      : origin = 0x00C000, length = 0x004000	 /* RAML4 now has 0x004000 bytes of memory, 16.4K */
